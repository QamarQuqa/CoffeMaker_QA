...
public class Inventory {
    ...
    public synchronized void addChocolate(String chocolate) throws InventoryException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing sugar value to an integer");
    		/* Real Bug
    		1. Correction the EXCEPTION message "Units of Choclate must be a positive integer"
    		2.  throw new InventoryException("Error in parsing Choclate value to an integer") 
    		*/
    	}
		if (amtChocolate >= 0) {
    ...
    public synchronized void addCoffee(String coffee) throws InventoryException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing Coffee value to an integer");
    		/* Real Bug
    		1. Correction the EXCEPTION message "Units of Coffee must be a positive integer"
    		2.  throw new InventoryException("Error in parsing Coffee value to an integer") 
    		*/
    	}
		if (amtCoffee >= 0) {
    ...
    public synchronized void addMilk(String milk) throws InventoryException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing Milk value to an integer");
    		/* Real Bug
    		1. Correction the EXCEPTION message "Units of Milk must be a positive integer"
    		2.  throw new InventoryException("Error in parsing Milk value to an integer") 
    		*/
    	}
		if (amtMilk >= 0) {
     ...
     * @throws InventoryException
     */
    public synchronized void addSugar(String sugar) throws InventoryException, NumberFormatException {
    	int amtSugar = 0;
    	try {
    		...
    		throw new NumberFormatException("Error in parsing sugar value to an integer");
    		/* Real Bug
    		1. Correction the EXCEPTION message "Units of sugar must be a positive integer"
    		2.  throw new InventoryException("Error in parsing sugar value to an integer") 
    		*/
    	}
		if (amtSugar >= 0) { // Correction : amtSugar <= 0
