...
public class Recipe {
    ...
    public void setAmtChocolate(String chocolate) throws RecipeException {
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing AmtChocolate value to an integer");
    		/* Real Bug
    ...
    public void setAmtCoffee(String coffee) throws RecipeException {
    	...
    	try {
    		...
    		2.  throw new RecipeException("Error in parsing Coffee value to an integer") 
    		*/
    	}
	 ...
	 */
    public void setName(String name) throws RecipeException { // correction
    	if(name != null) {
    		this.name = name;
    	} else {
    		throw new RecipeException("Name cannot be NULL");	
    	}
	}
    /**
    ...
    public void setPrice(String price) throws RecipeException{
    	...
    	try {
    		...
    		throw new NumberFormatException("Error in parsing price value to an integer");
    		/* Real Bug
    		1. Correction the EXCEPTION message "Units of Coffee must be a positive integer"
    		2.  throw new RecipeException("Error in parsing Coffee value to an integer") 
    		*/
